...
This repository implements the project for course 4 of the Udacity Cloud Developer Nanodegree. In this project, a simple TODO application is implemented on AWS Lambda using the Severless framework.
